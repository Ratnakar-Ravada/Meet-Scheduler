        ...
        {isAuthenticated ? (
          ...
          <div className={`max-w-2xl mx-auto mt-16 text-center ${showAnimation ? 'animate-slide-up' : 'opacity-0'}`}>
            ...
            <p className="text-xl mb-8 text-muted-foreground px-4 max-w-xl mx-auto">
              Create and join meetings with a single click. Schedule for later or start one instantly.
            </p>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              <div className="p-6 rounded-2xl bg-white shadow-sm border">
                ...
                <p className="text-muted-foreground">Start a meeting immediately with a single click. Perfect for impromptu conversations.</p>
              </div>
              
              <div className="p-6 rounded-2xl bg-white shadow-sm border">
                <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                  <svg className="h-6 w-6 text-primary" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 2V5M16 2V5M3.5 9.09H20.5M3 8.5C3 7.12 4.12 6 5.5 6H18.5C19.88 6 21 7.12 21 8.5V18.5C21 19.88 19.88 21 18.5 21H5.5C4.12 21 3 19.88 3 18.5V8.5Z" 
                      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <h3 className="text-lg font-semibold mb-2">Scheduled Meetings</h3>
                <p className="text-muted-foreground">Plan ahead by scheduling meetings for a specific date and time.</p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white shadow-sm border">
                ...
                <h3 className="text-lg font-semibold mb-2">Simple Authentication</h3>
                <p className="text-muted-foreground">Sign in with your Google account for a seamless experience.</p>
              </div>
            </div>
          </div>
        )}
